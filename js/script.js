! function (e) {
    ...
    twitterFetcher.fetch(c), e(".block-tabs li").on("click", function () {
        if (!e(this).hasClass("active")) {
            var i = e(this).index() + 1;
            e(".block-tabs li.active").removeClass("active"), e(this).addClass("active"), e(".block-tab li.active").removeClass("active"), e(".block-tab li:nth-child(" + i + ")").addClass("active")
        }
    });
    var d = e(".album"),
        r = audiojs.create(d, {
            trackEnded: function () {
                var i = e(".playlist li.playing").next();
                i.length || (i = e(".playlist li").first()), i.addClass("playing").siblings().removeClass("playing"), audio1.load(e(".as-link", i).attr("data-src")), audio1.play()
            }
        })[0],
        f = e(".playlist li .as-link").attr("data-src");
    e(".playlist li ").first().addClass("pause"), r.load(f), e(".playlist li").on("click", function () {
        ...
        return e(this).closest(".playlist li").find(".block-lyrics").slideToggle(), e(this).toggleClass("selected"), !1
